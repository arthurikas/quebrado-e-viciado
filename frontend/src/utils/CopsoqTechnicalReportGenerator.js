...
<div class="container">
    ...
    <!-- ===== SEÇÃO IV ===== -->
    <section>
        <h2>Seção IV — Identificação da Empresa e Responsável Técnico</h2>
    ...
    <!-- ===== SEÇÃO VI ===== -->
    <section>
        <h2>Seção VI — Resultados por Domínio Psicossocial</h2>
    ...
    <section>
        ...
        <h3>9.1 Ritmo de Trabalho e Exigências Quantitativas</h3>
        <ul>
        ...
        <h3>9.2 Exigências Emocionais e Saúde Mental</h3>
        <ul>
        ...
        <h3>9.3 Liderança e Ambiente Organizacional</h3>
        <ul>
    ...
    <!-- ===== SEÇÃO X ===== -->
    <section>
        <h2>Seção X — Considerações Finais e Recomendações</h2>
